...
public class ServicioWebViabilidadProxy implements co.gov.colpensiones.www.bdua.contracts._1_0.personas.ServicioWebViabilidad {
  ...
  public ServicioWebViabilidadProxy() {
    _initServicioWebViabilidadProxy();
  }
  
  public ServicioWebViabilidadProxy(String endpoint) {
    _endpoint = endpoint;
    _initServicioWebViabilidadProxy();
  }
  
  private void _initServicioWebViabilidadProxy() {
    try {
  ...
  public co.gov.colpensiones.www.bdua.contracts._1_0.personas.ServicioWebViabilidad getServicioWebViabilidad() {
    if (servicioWebViabilidad == null)
      _initServicioWebViabilidadProxy();
