 ...
 */
@WebService(targetNamespace = "http://www.colpensiones.gov.co/beps/contracts/1.0/certificados", name = "SvcCertificadosBizagi")
...
@MTOM(enabled=false)
public interface SvcCertificadosBizagi {
