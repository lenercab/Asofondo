...
import co.gov.colpensiones.schemas.afiliado.personas.TipoCriteriosCertificacionAfiliacionDTO;
import co.gov.colpensiones.schemas.afiliado.personas.TipoEstadoAfiliacionFondosPrivadosDTO;
import co.gov.colpensiones.schemas.afiliado.personas.TipoIdentificacionPersona;
import co.gov.colpensiones.schemas.afiliado.personas.TipoInformacionActualizacionAfiliacionDTO;
import co.gov.colpensiones.schemas.afiliado.personas.TipoInformacionBasicaIdentificacionPersona;
import co.gov.colpensiones.schemas.afiliado.personas.TipoInformacionCertificacionDTO;
import co.gov.colpensiones.schemas.afiliado.personas.TipoInformacionGeneralPersonaDTO;
import co.gov.colpensiones.schemas.afiliado.personas.TipoInformacionRegistroInicialAfiliacionDTO;
import co.gov.colpensiones.schemas.afiliado.personas.TipoInformacionRegistroRelacionLaboralDTO;


/**
 * This object contains factory methods for each 
 * Java content interface and Java element interface 
 * generated in the co.gov.colpensiones.contracts.afiliado.personas package. 
...
public class ObjectFactory {
    ...
    private final static QName _InformacionRegistroActualizarRelacionLaboralDTO_QNAME = new QName("http://www.colpensiones.gov.co/contracts/1.0/personas", "InformacionRegistroActualizarRelacionLaboralDTO");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: co.gov.colpensiones.contracts.afiliado.personas
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.colpensiones.gov.co/contracts/1.0/personas", name = "InformacionRegistroActualizarRelacionLaboralDTO")
    public JAXBElement<TipoInformacionRegistroRelacionLaboralDTO> createInformacionRegistroActualizarRelacionLaboralDTO(TipoInformacionRegistroRelacionLaboralDTO value) {
        return new JAXBElement<TipoInformacionRegistroRelacionLaboralDTO>(_InformacionRegistroActualizarRelacionLaboralDTO_QNAME, TipoInformacionRegistroRelacionLaboralDTO.class, null, value);
    }
